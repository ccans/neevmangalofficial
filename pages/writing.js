      ...
      <div>
        ...
        <main>
          <div className="fixed w-full h-auto" >
            ...
            <div className="flex flex-row justify-center px-30" style={{minHeight: "100vh"}}> 
                ...
                <WritingCard address="blog/fourjuly" backgroundCol="#ffffff" title="The Delicate Dance of Foil, Fate, and Fortune" subttl="Character Analysis of The Odyssey" img="http://www.sacred-texts.com/cla/homer/ody/img/homer.jpg" />
