...
function MainStripe() {
    return (
        <motion.div className="z-20 flex w-screen md:justify-end justify-center w-screen md:w-1/3 overflow-hidden" initial="hidden" animate="visible" variants={{
            ...
            <div className="h-screen w-3/4 w-full bg-black float-right p-4 dark:bg-white table">
                ...
                <h3 className="dark:text-black text-white font-light table-row align-bottom" style={{fontFamily: "Rajdhani"}}> Luftmensch <em> (yiddish) </em>: Refers to someone who is a bit of a dreamer, and literally means "air person" </h3>
            </div>
        </motion.div>
    )
}
