    ...
    return (
        <motion.div className="z-20 flex w-full md:justify-end justify-center w-screen md:w-1/3 overflow-hidden"  style={{minHeight: "90vh"}} initial="hidden" animate="visible" variants={{
            ...
            <div className="w-full bg-black float-right p-4 dark:bg-white flex relative flex-col">
                <h1 className="dark:text-black text-white tracking-wide" style={{fontFamily: "Bebas Neue", fontSize: "125px", lineHeight: "110px"}}> Neev Mangal</h1>
                <h3 className="dark:text-black text-white text-xl tracking-wider mb-2" style={{fontFamily: "Rajdhani"}}> Professional Angry Bird </h3>
